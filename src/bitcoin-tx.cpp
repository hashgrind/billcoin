...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " billcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  billcoin-tx [options] <hex-tx> [commands]  Update hex-encoded billcoin transaction\n" +
            "or:     billcoin-tx [options] -create [commands]   Create hex-encoded billcoin transaction\n" +
            "\n";
