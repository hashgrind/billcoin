...
{
    const char* pszTimestamp = "Coindesk 05/Mar/2021 Nyan Dogecoin NFT Fetches $69K in ETH";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x55e79e81009603f9f3038f3b916b382c44b2649e98425c8fb9302bd1a3775e6a");
        ...
        consensus.defaultAssumeValid = uint256S("0x55e79e81009603f9f3038f3b916b382c44b2649e98425c8fb9302bd1a3775e6a"); //1683528
        ...
        genesis = CreateGenesisBlock(1615001678, 2085919074, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x55e79e81009603f9f3038f3b916b382c44b2649e98425c8fb9302bd1a3775e6a"));
        assert(genesis.hashMerkleRoot == uint256S("0xdbf4419bd337cf3bab0571c5c7377bc9878eac687b7c6144db9726a9ca14712f"));
        ...
        vSeeds.emplace_back("seed0.billcoin.xyz");
        vSeeds.emplace_back("seed1.billcoin.xyz");
        vSeeds.emplace_back("seed2.billcoin.xyz");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x55e79e81009603f9f3038f3b916b382c44b2649e98425c8fb9302bd1a3775e6a")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = ; // January 1, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT; // January 31st, 2018
        ...
        genesis = CreateGenesisBlock(1565582448, 2085976420, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3644a46b75a2670fd6c8968c6eaf4c44a3faa0566042110f3c5067f3eb9143a5"));
        assert(genesis.hashMerkleRoot == uint256S("0xdbf4419bd337cf3bab0571c5c7377bc9878eac687b7c6144db9726a9ca14712f"));
        ...
        checkpointData = {
            {
                {0, uint256S("3644a46b75a2670fd6c8968c6eaf4c44a3faa0566042110f3c5067f3eb9143a5")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1296688602, 2085919971, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6ba5b738548804154586a49ed8c1f56c79b9c611b81b94db539327cc647b1b69"));
        assert(genesis.hashMerkleRoot == uint256S("0xdbf4419bd337cf3bab0571c5c7377bc9878eac687b7c6144db9726a9ca14712f"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x6ba5b738548804154586a49ed8c1f56c79b9c611b81b94db539327cc647b1b69")},
            }
        };
