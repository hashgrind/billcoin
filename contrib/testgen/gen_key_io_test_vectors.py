...
bech32_templates = [
  ...
  ('bil',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('bil',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('bil',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbil',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbil',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbil',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbil',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbil',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbil', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbil',  17, 32, False, False, False),
  ('rbil',  3,  1, False, False, False),
  ('bil',   15, 41, False, False, False),
  ('tbil',  0, 16, False, False, False),
  ('rbil',  0, 32, True,  False, False),
  ('bil',   0, 16, True,  False, False),
  ('tbil',  0, 32, False, True,  False),
  ('rbil',  0, 20, False, False, True)
]
