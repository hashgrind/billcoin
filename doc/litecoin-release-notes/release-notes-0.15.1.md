Billcoin Core version *0.15.1* is now available from:

  <https://download.billcoin.org/billcoin-0.15.1/>
...
A number of changes to the way Billcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 sudos per kB (0.00001 BIL). This is to prepare for dropping the minimum transaction fee to 0.1 sudos per kB (0.0001 BIL) in the next release.
