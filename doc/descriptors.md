# Support for Output Descriptors in Billcoin Core

Since Billcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `bil1...` for mainnet or `tbil1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Billcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Billcoin Core wallets, a convenience function `combo` is
